...
class Const {
  ...
  /* ユーザー(複数形) */ static const String USERS = "users";
  /* 名前 */ static const String NAME = "name";
  /* メールアドレス */ static const String MAIL = "mail";
  /* メッセージ */ static const String MESSAGE = "message";
  /* ヘッダー画像のパス */ static const String HEADER_IMAGE_PATH = "header_image_path";
  ...
  /* 送信したフレンド申請(複数形) */ static const String SEND_APPLICATIONS = "send_applications";
  /* フレンド(単数形) */ static const String FRIEND = "friend";
  /* フレンド(複数形) */ static const String FRIENDS = "friends";
  ...
  /* 更新日 */ static const String UPDATE = "update";
  /* 削除日 */ static const String DELETE = "delete";
