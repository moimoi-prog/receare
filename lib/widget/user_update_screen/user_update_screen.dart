...
import 'package:receare/common/camera_module.dart';
...
import 'package:receare/widget/parts/header_image_crop_page.dart';
import 'package:receare/widget/parts/icon_image_crop_page.dart';
...
class UserUpdateScreen extends StatefulWidget {
  ...
  const UserUpdateScreen({Key key, this.userDoc})
      : assert(userDoc != null),
        super(key: key);
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    await Provider.of<UserDetailScreenNotifier>(context, listen: false).loadUser(widget.userDoc.id);
