...
import 'package:receare/widget/parts/user_name_widget.dart';
...
// シャウト明細画面
// ----------------------------------------
class ShoutDetailScreen extends StatelessWidget {
  /* shoutデータ */ final Map<String, dynamic> shoutMap;

  ShoutDetailScreen({Key key, this.shoutMap}) : super(key: key);
          ...
          children: <Widget>[
            ...
            Expanded(
              child: RefreshIndicator(
                onRefresh: () async {
                  Provider.of<ShoutListScreenNotifier>(context, listen: false).reloadComments(shoutMap[Strings.ID]);
                },
    ...
    return ListTile(
      leading: InkWell(
        ...
        onTap: () {
          ...
          Provider.of<UserDetailScreenNotifier>(context, listen: false).load(commentDoc.data()[Strings.UID]);
